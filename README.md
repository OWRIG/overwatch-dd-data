...
下面是一次本地报告的**去标识化聚合摘要**，用于展示输出形态。README 不放 token、玩家名、`bnetId`、逐场明细或完整原始截图；完整报告和工作簿请保留在本地 `report.txt` / `outputs/`，不要提交。

**最近 1000 场快速**

| 指标 | 结果 |
|---|---:|
| 时间范围 | 2026-02-21 至 2026-07-04 |
| 总战绩 | 493胜 / 507负 |
| 总胜率 | 49.3% |
| 详情样本 | 1000/1000 场 |
...
| 表现较好 | 场次 / 胜率 | 表现较差 | 场次 / 胜率 |
|---|---:|---|---:|
| D.Va | 21场 / 71.4% | 安娜 | 131场 / 42.7% |
| 查莉娅 | 30场 / 63.3% | 索杰恩 | 68场 / 45.6% |
| 士兵：76 | 21场 / 61.9% | 末日铁拳 | 95场 / 47.4% |
| 艾什 | 43场 / 58.1% | 弗蕾娅 | 66场 / 47.0% |

**阵容信号**

| 维度 | 观察 |
|---|---|
| 本方角色结构 | 标准 `1 tank + 2 dps + 2 healer` 为 943场 / 50.3%，非标准结构明显偏低 |
| 职责表现 | DPS 50.8%，Tank 50.5%，Healer 45.2% |
| 好搭配示例 | D.Va + 安娜：17场 / 76.5%；雾子 + 安娜：21场 / 71.4% |
| 低胜率搭配示例 | 安娜 + 路霸：11场 / 9.1%；安娜 + 天使：20场 / 25.0% |
